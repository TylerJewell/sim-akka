...
A `LICENSE-sim` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [simstudioai/sim](https://github.com/simstudioai/sim), Copyright
2026 Sim Studio, Inc, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../sim-port/specs/SPEC-001-sim.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
